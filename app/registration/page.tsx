    ...
    <div className="bg-gradient-to-b from-white to-gray-50 py-16 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-gray-700 text-md mb-6">
          JRMT is scheduled to happen on Saturday, January 24th, 2026 at Jackson-Reed High School in Washington DC. The registration deadline is Thursday, January 22nd, 2026.
        </p>
