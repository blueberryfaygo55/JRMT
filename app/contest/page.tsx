    ...
    <div className="bg-gradient-to-b from-white to-gray-50 py-12">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-center mb-6">
          <h1 className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">Contest Format</h1>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-center justify-center space-x-8 mb-6">
            <div className="text-center">
              <div className="text-indigo-600 text-xl font-bold mb-1">May 17, 2025</div>
              <div className="text-gray-500 text-sm">Saturday</div>
            </div>
            <div className="text-center">
              <div className="text-indigo-600 text-xl font-bold mb-1">9:30 AM - 4:00 PM</div>
              <div className="text-gray-500 text-sm">Check-in at main gate</div>
            </div>
            <div className="text-center">
              <div className="text-indigo-600 text-xl font-bold mb-1">Free Pizza</div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="grid gap-6">
            ...
            <div className="border-l-4 border-indigo-400 pl-4">
              <h3 className="text-lg font-semibold text-indigo-600 mb-1">Speed Round</h3>
            ...
            <div className="border-l-4 border-indigo-500 pl-4">
              <h3 className="text-lg font-semibold text-indigo-600 mb-1">Accuracy Round</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="border-l-4 border-indigo-600 pl-4">
              <h3 className="text-lg font-semibold text-indigo-600 mb-1">Team Round</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="border-l-4 border-indigo-700 pl-4">
              <h3 className="text-lg font-semibold text-indigo-600 mb-1">Guts Round</h3>
              <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="text-lg font-semibold text-indigo-600 mb-2">Individual Score</h3>
              <p className="text-gray-600 text-sm">Speed (150) + Accuracy (150) = <span className="font-bold">300 points max</span></p>
            </div>

            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="text-lg font-semibold text-indigo-600 mb-2">Team Score</h3>
          ...
          <div className="bg-indigo-50 p-4 rounded-lg text-center">
            <p className="text-indigo-700 font-medium">Medals will be awarded to the top 5 contestants in each individual round, and the top 5 teams overall.</p>
          </div>
        </div>
